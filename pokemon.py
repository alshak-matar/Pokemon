...
if __name__ == '__main__':
    ...
    Venusaur = Pokemon('Venusaur', 'Grass', ['Vine Wip', 'Razor leaf', 'Earthquak', 'Frenzy Plant'], {'ATTACK':8, 'DEFENSE': 12})

    Charmander = Pokemon('Charmander', 'Fire', ['Ember', 'Ember', 'Scratch', 'Tackle', 'Fire Punch'], {'ATTACK':4, 'DEFENSE': 2})
